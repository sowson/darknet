...
int ch_get_all_valid_moves(char *pgn, char **valid_fen, char ***valid_moves, int *valid_moves_count);
int ch_get_all_valid_moves_after(char *pgn, char *move, char **valid_fen, char ***valid_moves, int *valid_moves_count);
...
int ch_is_end(char *valid_fen, int idx);
int ch_is_checkmate_move(char *valid_fen, int idx);
int ch_is_queen_attacked_move(char *valid_fen, int idx);
int ch_is_take_move(char *valid_fen, int idx);
int ch_is_check_move(char *valid_fen, int idx);
int ch_board_after_move(char* valid_fen, char* valid_move, char** valid_fen_next, int *valid_move_idx, int *valid_move_cnt);
...
int ch_is_legal(char* fen, int indext);
char* ch_do_legal(char* fen, int indext);
...
float* ch_eval_the_board_moves(const char* sfen, const float* board, float* best_value, int* best_value_index);
