...
set_target_properties(clBLAS PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/clBLAS/clBLAS.lib"
##IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "C:/Program Files (x86)/AMD APP SDK/3.0/lib/x86_64/OpenCL.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/clBLAS/clBLAS.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS clBLAS )
list(APPEND _IMPORT_CHECK_FILES_FOR_clBLAS "${_IMPORT_PREFIX}/clBLAS/clBLAS.lib" "${_IMPORT_PREFIX}/clBLAS/clBLAS.dll" )
